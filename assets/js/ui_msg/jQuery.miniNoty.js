...
;(function($){
	...
	$.miniNoty = function(message, view){
		...
		//manage popup position edit by aijaz on date 26 jan 2016
		var winWidth = $( window ).width();
		var popupWd = $('.miniNoty').width();
		centerVal = (winWidth/2)-(popupWd/2)
		$('.miniNoty').css({"right":centerVal,"top":"200px"});
